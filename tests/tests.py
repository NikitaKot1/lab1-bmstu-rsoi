...
url0 = "https://lab1-bmstu-rsoi.onrender.com"
...
def test_post_get(persons):
    r = requests.post(url="https://lab1-bmstu-rsoi.onrender.com/api/v1/persons", json=persons)
...
def test_post_delete(persons):
    r = requests.post(url="/https://lab1-bmstu-rsoi.onrender.comapi/v1/persons", json=persons)
    redirected_urd = r.headers['Location']
